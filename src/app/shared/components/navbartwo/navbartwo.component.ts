    ...
    switch (notification.type) {
      ...
      case 'BOOKING_COMPLETED':
        if (notification.relatedEntityId) {
          this.router.navigate(['/vender/booking-requests'], { 
            queryParams: { bookingId: notification.relatedEntityId } 
          });
        } else {
          this.router.navigate(['/vender/booking-requests']);
        }
      ...
      case 'MEETING_REMINDER':
        if (notification.relatedEntityId) {
          this.router.navigate(['/vender/meeting-requsts'], { 
      ...
      case 'PAYMENT_FAILED':
        this.router.navigate(['/vender'], { fragment: 'payments' });
        break;
        
      case 'REVIEW_RECEIVED':
        this.router.navigate(['/vender/profile'], { fragment: 'reviews' });
        break;
        
      case 'FOLLOW_REQUEST':
        this.router.navigate(['/vender/profile'], { fragment: 'followers' });
        break;
