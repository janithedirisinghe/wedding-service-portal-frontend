...
import { SupportDTO, SupportSeverity } from '../models/support.model';
import { Router } from '@angular/router';

@Component({
  selector: 'app-customer-help-support',
  templateUrl: './customer-help-support.component.html',
  styleUrl: './customer-help-support.component.scss'
})
export class CustomerHelpSupportComponent implements OnInit {
